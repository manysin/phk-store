"use client";
import { Dropdown, MegaMenu, Navbar, NavbarLink } from "flowbite-react";
    ...
    <main>
      <section className="bg-gray-900 font-semibold text-gray-100 py-3 container max-w-screen-2xl">
        <div className=" flex justify-between items-center">
          <h1 className="text-xl">Black Friday</h1>
      ...
      <section className="bg-blue-800 text-gray-100 py-4 container max-w-screen-2xl">
        <div className="flex justify-between items-center">

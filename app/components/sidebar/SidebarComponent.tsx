...
>      <div className="w-80 h-[98vh] fixed z-10 flex items-center flex-col justify-between  right-3 top-3  shadow-slate-700 shadow-lg  bg-white px-4 rounded-3xl animate-slideInFromRight">
            ...
            <div className="w-full flex flex-col justify-center items-center">
                ...
                <Link href={"/edit-profile"} className="w-full text-white bg-gradient-to-r from-purple-500 via-purple-600 to-purple-700 hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-purple-300 dark:focus:ring-purple-800 font-medium rounded-lg text-sm px-5 py-2.5 text-center me-2 mb-2" >Edit Profile</Link>

...
const Page = () => {
  return (
    <div>
      <section className="bg-gray-100 py-8 antialiased dark:bg-gray-900 md:py-20  ">
        <div className="mx-auto max-w-screen-xl px-4 2xl:px-0">
          <div className="mx-auto max-w-5xl">
            <h2 className="text-xl font-bold text-blue-900 sm:text-3xl uppercase">Payment</h2>
            <hr className='mt-2' />
              ...
              <div className="mt-6 grow sm:mt-8 lg:mt-0">
                ...
                <div className="mt-6 flex items-center justify-center gap-8">
                  <Image
                    ...
                    src="/payment/ic_ABA-PAY_3x.png"
                    alt="Paypal logo"
                    width={200}  // You can adjust the width and height
                    height={200}
                  />
                  <Image
                    className="h-8 w-auto dark:hidden"
